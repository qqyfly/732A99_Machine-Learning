...
\hypertarget{assignment-1-kernel-methods}{%
\subsection{Assignment 1: KERNEL
METHODS}\label{assignment-1-kernel-methods}}

\hypertarget{answer}{%
\subsubsection{Answer:}\label{answer}}

\hypertarget{assignment-2-support-vector-machines}{%
\subsection{Assignment 2: SUPPORT VECTOR
MACHINES}\label{assignment-2-support-vector-machines}}

\hypertarget{answer-1}{%
\subsubsection{Answer:}\label{answer-1}}

\hypertarget{assignment-3-neural-networks}{%
\subsection{Assignment 3: NEURAL
NETWORKS}\label{assignment-3-neural-networks}}
